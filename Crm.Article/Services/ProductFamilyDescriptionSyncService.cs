namespace Crm.Article.Services
{
	...
	public class ProductFamilyDescriptionSyncService : DefaultLookupSyncService<ProductFamilyDescription>
	{
		...
		public ProductFamilyDescriptionSyncService(IRepositoryWithTypedId<ProductFamilyDescription, Guid> repository, RestTypeProvider restTypeProvider, IRestSerializer restSerializer, IMapper mapper, ISyncService<ProductFamily> productFamilySyncService)
