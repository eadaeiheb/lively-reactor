namespace Crm.Article.Services
{
	...
	public class StockSyncService : DefaultSyncService<Stock, Guid>
	{
		private readonly IEnumerable<IContactSyncService> articleSyncServices;
		private readonly IAuthorizationManager authorizationManager;
		public StockSyncService(
			IRepositoryWithTypedId<Stock, Guid> repository,
		...
		public override IQueryable<Stock> GetAll(User user, IDictionary<string, int?> groups, IDictionary<string, Guid> clientIds)
		{
