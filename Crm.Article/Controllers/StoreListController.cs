namespace Crm.Article.Controllers
{
	...
	public class StoreListController : GenericListController<Store>
	{
		...
		[RequiredPermission(PermissionName.Index, Group = ArticlePlugin.PermissionGroup.Store)]
		...
		[RequiredPermission(PermissionName.Create, Group = ArticlePlugin.PermissionGroup.Store)]
