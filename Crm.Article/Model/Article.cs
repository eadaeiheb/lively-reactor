namespace Crm.Article.Model
{
	...
	public class Article : Contact, IEntityWithTags
	{
		...
		public virtual string DrivingLicenceCategoryKey { get; set; }
		...
		public virtual string TUV { get; set; }
		public virtual string Inspection { get; set; }
		...
		{
			get { return QuantityUnitEntry != null ? LookupManager.Get<QuantityUnit>(QuantityUnitEntry.QuantityUnitKey) : null; }
		}
		[IgnoreMap]
		...
		[IgnoreMap]
		public virtual DrivingLicenceCategory DrivingLicenceCategory
		{
			get { return DrivingLicenceCategoryKey != null ? LookupManager.Get<DrivingLicenceCategory>(DrivingLicenceCategoryKey) : null; }
		}
