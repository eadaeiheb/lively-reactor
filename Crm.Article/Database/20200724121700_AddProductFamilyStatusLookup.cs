namespace Crm.Article.Database
{
	...
	public class AddProductFamilyStatusLookup : Migration
	{
        ...
        SET IDENTITY_INSERT [LU].[ProductFamilyStatus] ON 
				...
				INSERT [LU].[ProductFamilyStatus] ([ProductFamilyStatusId], [Name], [Language], [Value], [Favorite], [SortOrder], [Color], [CreateDate], [ModifyDate], [CreateUser], [ModifyUser], [IsActive]) VALUES (9, N'Eingestellt', N'de', N'retired', 0, 0, N'#9E9E9E', GETUTCDATE(), GETUTCDATE(), 'Migration_20200724121700', 'Migration_20200724121700', 1)
