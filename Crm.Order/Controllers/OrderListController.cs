namespace Crm.Order.Controllers
{
	...
	public class OrderListController : GenericListController<Order>
	{
		...
		[RequiredPermission(nameof(Order), Group = MainPlugin.PermissionGroup.TopSearch)]
		...
		public class OrderCsvDefinition : CsvDefinition<Order>
		{
			...
			public override IEnumerable<KeyValuePair<string, Func<Order, object>>> GetCsv(IEnumerable<Order> items) {
