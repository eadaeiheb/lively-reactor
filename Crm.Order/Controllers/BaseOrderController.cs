namespace Crm.Order.Controllers
{
	...
	public class BaseOrderController : Controller
	{
		...
		public virtual ActionResult CalculationTab()
		{
			...
			{
				DisplayPurchasePrices = authorizationManager.IsAuthorizedForAction(userService.CurrentUser, ArticlePlugin.PermissionGroup.Article, ArticlePlugin.PermissionName.ViewPurchasePrices)
			};
		...
		public virtual ActionResult RecipientsTemplate() => PartialView();
