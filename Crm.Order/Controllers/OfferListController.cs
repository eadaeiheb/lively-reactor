namespace Crm.Order.Controllers
{
	...
	public class OfferListController : GenericListController<Offer>
	{
		...
		[RequiredPermission(nameof(Offer), Group = MainPlugin.PermissionGroup.TopSearch)]
		...
		public class OfferCsvDefinition : CsvDefinition<Offer>
		{
			...
			public override IEnumerable<KeyValuePair<string, Func<Offer, object>>> GetCsv(IEnumerable<Offer> items) {
