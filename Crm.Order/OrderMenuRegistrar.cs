namespace Crm.Order
{
	...
	public class OrderMenuRegistrar : IMenuRegistrar<MaterialMainMenu>
	{
		...
		{
			menuProvider.Register(null, "Sales", iconClass: "zmdi zmdi-money-box", priority: 500);
			if (appSettingsProvider.GetValue(OrderPlugin.Settings.System.Offers.Enabled))
			{
				menuProvider.Register("Sales", "Offers", priority: 500, url: "~/Crm.Order/OfferList/IndexTemplate");
				menuProvider.AddPermission("Sales", "Offers", OrderPlugin.PermissionGroup.Offer, PermissionName.View);
			}

			menuProvider.Register("Sales", "Orders", priority: 400, url: "~/Crm.Order/OrderList/IndexTemplate");
