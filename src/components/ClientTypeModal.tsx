...
const ClientTypeModal = ({ onSelect }: ClientTypeModalProps) => {
  return (
    <div 
      ...
      style={{
        backgroundImage: 'url(Blured.png)', // replace with your image path
    ...
    >
      <div className="bg-white rounded-2xl p-8 max-w-2xl w-full shadow-2xl animate-[slideIn_0.5s_ease-out]">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-playfair mb-3 bg-gradient-to-r from-[#96cc39] to-[#64381b] bg-clip-text text-transparent">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="relative flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-[#96cc39]/10 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <Building2 size={32} className="text-[#96cc39]" />
              </div>
              <h3 className="text-xl font-playfair mt-4 mb-2 text-gray-900">
          ...
          >
            ...
            <div className="relative flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-[#64381b]/10 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
