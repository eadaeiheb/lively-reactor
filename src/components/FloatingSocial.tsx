...
const FloatingSocials = () => {
  const socials = [
    { icon: <Instagram className="h-5 w-5" />, href: '#', label: 'Suivez-nous sur Instagram' },
    { icon: <Facebook className="h-5 w-5" />, href: '#', label: 'Rejoignez-nous sur Facebook' },
    { icon: <Youtube className="h-5 w-5" />, href: '#', label: 'Regardez nos vidéos' },
    { icon: <Twitter className="h-5 w-5" />, href: '#', label: 'Suivez-nous sur Twitter' },
